...
export default function QueryBot({ input, engineOutput, narrative }: { input: PatientInput; engineOutput: EngineOutput; narrative: string }) {
    ...
    <div className="section-card">
      ...
      <div className="flex gap-2">
        <input
          ...
          placeholder="e.g. Should I use ticagrelor or prasugrel here?"
          value={question}
